<?php 
	...
	class Login extends Controllers{
		...
		{
			$data['page_tag'] = "Control de acceso";
			$data['page_title'] = "Control de acceso";
		...
		public function confirmUser(string $params){
			...
			if(empty($params)){
				...
				if(empty($arrResponse)){
					...
					$data['page_tag'] = "Restablacer contraseña";
					$data['page_name'] = "Restablacer contraseña";
					$data['page_title'] = "Restablacer contraseña";
					$data['email'] = $strEmail;
					$data['token'] = $strToken;
