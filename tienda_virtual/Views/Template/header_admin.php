...
<html lang="es">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Coza store</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <a class="dropdown-item"  href="https://firebasestorage.googleapis.com/v0/b/portafolio-juriar-7a7d5.appspot.com/o/Proyecto.pdf?alt=media&token=5dbf20ed-8082-42f1-8058-adf8d1fafef6"  download="Proyecto.pdf" target="proyecto">Download</a>
